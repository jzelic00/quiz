<?php
	...
	$dept = array();
	$nizIskoristenih = array(0,0,0,0); // Broj elemenata ovog niza ovisi o tome koliko cemo odgovora ponuditi korisniku na izbor (fixno 4)
					...
					for($i=0; $i< $brojPitanja; $i++)
					{
						...
						PostaviPitanje();
							...
							<div id="div'.$i.'">
									...
									<div class="gumbici">
										<button type="button" class="button" value="' . $odgovor1 . '" onclick="myFunction(value)"> '. $odgovor1 . '</button><br>
										<button type="button" class="button" value="' . $odgovor2 . '" onclick="myFunction(value)"> '. $odgovor2 . '</button><br>
										<button type="button" class="button" value="' . $odgovor3 . '" onclick="myFunction(value)"> '. $odgovor3 . '</button><br>
										<button type="button" class="button" value="' . $odgovor4 . '" onclick="myFunction(value)"> '. $odgovor4 . '</button><br>
									</div>
							</div>';								
					};
